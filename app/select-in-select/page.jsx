...
import {updateQueryById, resetQueryById, markSubmitted, setStatus, setSeeHint} from '../store/slices/selectInSelect'
...
const data = useSelector(state => state.selectInSelect);
...
return ( <div className='w-full px-12 py-3'> <div className='w-full rounded-md mb-3 bg-gray-200 p-1'><h1 className='text-3xl my-2 font-bold'>SELECT within SELECT Tutorial</h1></div> <div className='bg-blue-500 h-[3px] w-full mb-2'></div>


    <World/>
    <p className='text-xl '>This tutorial looks at how we can use <span className='font-semibold'>SELECT statements within SELECT statements</span> to perform more complex queries.</p>
    <Link href={'/using-nested-select'}><p className='text-xl my-4 mb-9 text-blue-500 underline'>Using nested SELECT</p></Link>
    ...
    <p className='text-xl mt-4 mb-24 py-4 px-6 border bg-gray-100 w-150 tracking-wide font-mono'>world(name, continent, area, population, gdp)</p>
