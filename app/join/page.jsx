...
import {updateQueryById, resetQueryById, markSubmitted, setStatus, setSeeHint} from '../store/slices/joinOperation'
...
const data = useSelector(state => state.joinOperation);
...
<div className='w-full rounded-md mb-3 bg-gray-200 p-1'><h1 className='text-3xl my-2 font-bold'>The JOIN operation</h1></div> <div className='bg-blue-500 h-[3px] w-full mb-2'></div>
  ...
  <div className='w-full rounded-md mb-3 bg-gray-200 p-1'><h1 className='text-3xl my-2 font-bold'>JOIN and UEFA EURO 2012</h1></div> <div className='bg-blue-500 h-[3px] w-full mb-2'></div>

    <p className='text-xl mb-7 mt-5'>This tutorial introduces JOIN which allows you to use data from two or more tables. The tables contain all matches and goals from UEFA EURO 2012 Football Championship in Poland and Ukraine.</p>

    <p className='text-xl mt-5 mb-24'>Summary</p>
