...
import {updateQueryById, resetQueryById, markSubmitted, setStatus, setSeeHint} from '../store/slices/selectFromWorld'
...
function Page() {
  ...
  const data = useSelector(state => state.selectFromWorld);
...
return ( <div className='w-full px-12 py-3'> <div className='w-full rounded-md mb-3 bg-gray-200 p-1'><h1 className='text-3xl my-2 font-bold'>SELECT from WORLD Tutorial</h1></div> <div className='bg-blue-500 h-[3px] w-full mb-2'></div>

  <World/>

    <p className='text-xl  mb-9'>In this tutorial you will use the SELECT command on the table <span className='font-semibold border px-1'>world</span></p>
          ...
          <div key={item.id} className=' gap-9 mb-[150px]'>
            ...
            <div className='flex gap-9 justify-between'>
              ...
              <div className='w-1/2 py-5'>
                  ...
                  <p onClick={() => handleHintToggler(item)} className='font-semibold my-4 text-blue-800 text-xl cursor-help'>{item.hintAbove}</p>
                  {query1Result[item.id]?.isHintShow && <p className='font-semibold my-4 text-xl cursor-help'>{item.hintBelow}</p>}
